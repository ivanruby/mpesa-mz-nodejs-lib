...
describe('C2B', function () {
  ...
  it('Should not initialize if transaction data object is incomplete or invalid', function () {
    assert.throws(
      ...
      Error,
      /Missing or invalid C2B parameters/
    )
  })
  ...
  describe('Amount', function () {
    it('Should be present', function () {
      assert.throws(
        ...
        Error,
        /Missing or invalid C2B parameters: C2B Amount/
      )
    })
  ...
  it('MSISDN: should be present and a valid 9 or 12 digits number', function () {
    assert.throws(
      ...
      Error,
      /Missing or invalid C2B parameters: C2B MSISDN/
    )
  ...
  it('Reference: should not be empty', function () {
    assert.throws(
      ...
      Error,
      /Missing or invalid C2B parameters: C2B Reference/
    )
  })
  ...
  it('Third-party reference: should not be empty', function () {
    assert.throws(
      ...
      Error,
      /Missing or invalid C2B parameters: C2B 3rd-party Reference/
    )
  })
})
