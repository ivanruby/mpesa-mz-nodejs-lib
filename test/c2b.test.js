  ...
  describe('C2B', function () {
    ...
    describe('Amount', function () {
      it('Should be present', function () {
        ...
        }, Error, /Missing or invalid configuration parameters: {2}C2B Amount/)
      })
      ...
      it('Should be greater than zero', function () {
        ...
        }, Error, /Missing or invalid configuration parameters: C2B Amount/)
      })
    })
    ...
    it('Reference: should not be empty', function () {
      ...
      }, Error, /Missing or invalid configuration parameters: C2B Reference/)
    })
    ...
    it('Third-party reference: should not be empty', function () {
      ...
      }, Error, /Missing or invalid configuration parameters: C2B 3rd-Party reference/)
    })
  })
}
