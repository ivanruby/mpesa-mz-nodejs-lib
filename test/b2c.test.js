...
describe('B2C', function () {
  ...
  it('Should not initialize if transaction data object is incomplete or invalid', function () {
    assert.throws(
      ...
      Error,
      /Missing or invalid B2C parameters/
    )
  })
  ...
  describe('Amount', function () {
    it('Should be present', function () {
      assert.throws(
        ...
        Error,
        /Missing or invalid B2C parameters: B2C Amount/
      )
    })
  ...
  it('MSISDN: should be present and a valid 9 or 12 digits number', function () {
    assert.throws(
      ...
      Error,
      /Missing or invalid B2C parameters: B2C MSISDN/
    )
  ...
  it('Reference: should not be empty', function () {
    assert.throws(
      ...
      Error,
      /Missing or invalid B2C parameters: B2C Reference/
    )
  })
  ...
  it('Third-party reference: should not be empty', function () {
    assert.throws(
      ...
      Error,
      /Missing or invalid B2C parameters: B2C 3rd-party Reference/
    )
  })
})
